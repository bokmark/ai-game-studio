...
**Scope:** `$ARGUMENTS[0]` (blank = ask user via the question tool)
...
If no argument is given, use the question tool:
...
- **GAPS [list]** → surface the specific gaps to the user via the question tool:
