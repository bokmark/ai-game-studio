...
**If no argument is provided**, do not fail — ask instead. Use the question tool:
...
2. **Questions**: Ask what is needed to draft this section. Use the question tool
...
3. **Options**: Where design choices exist, present 2-4 approaches with pros/cons.
   Explain reasoning in conversation, then use the question tool to capture the decision.
4. **Decision**: User picks an approach or provides custom direction.
5. **Draft**: Write the section content in conversation for review. Flag provisional
   assumptions explicitly.
6. **Approval**: Use the question tool:
...
7. **Write**: Use the question tool: "May I write the [section name] section to `[filepath]`?"
...
- Use the question tool to capture the choice:
...
- Use the question tool: "Want an ASCII wireframe as part of this spec?"
...
Use the question tool to step through items in groups of 3-4, not all at once.
...
Work through patterns in groups. Use the question tool:
...
When delegating to another agent as a subagent:
