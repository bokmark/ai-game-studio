...
Otherwise, use the question tool to confirm intent before proceeding:
...
Assess which path best fits the hypothesis, then use the question tool with your
...
2. **Choose path** — same the question tool widget as Phase 3 (HTML / Engine / Paper).
