...
- If the file doesn't exist and this is a `new` sprint: use the question tool:
...
3. Ask the user what to change: stories to add, remove, reprioritize, or re-estimate. Use the question tool to gather changes.
...
If CONCERNS, use the question tool:
