...
> Usage: `$team-polish [feature or area]` — specify the feature or area to polish (e.g., `combat`, `main menu`, `inventory system`, `level-1`). Do not use the question tool here; output the guidance directly.
...
- `performance-analyst` — Profiling, optimization, memory analysis
- `engine-programmer` — Engine-level fixes for rendering, memory, resource loading
- `technical-artist` — VFX polish, shader optimization, visual quality
- `sound-designer` — Audio polish, mixing, ambient layers
- `tools-programmer` — Content pipeline and editor tool verification
- `qa-tester` — Edge case testing, regression testing, soak testing
