...
- **CONCERNS** → surface the specific ADRs or recommendations flagged; use the question tool with options: `Revise the impact assessment` / `Accept with noted concerns` / `Discuss further`
