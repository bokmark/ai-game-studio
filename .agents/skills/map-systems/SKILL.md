...
Then use the question tool to capture feedback:
...
Use the question tool to ask: "Does this dependency ordering look right? Any
...
Use the question tool to ask: "Do these priority assignments match your vision?
...
Use the question tool for: "Start designing [system-name] now, pick a different
system, or stop here?"
...
After `$design-system` completes, use the question tool:
...
After the systems index is created (or after designing some systems), present next actions using the question tool:
