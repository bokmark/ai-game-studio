> [English 原版 / English Original](README.en.md)
> 本文件为默认中文版本;同步基线:commit `0de6c40`(2026-07-29)+ 双平台 README 同步;如有出入以英文版为准。
...
.github/                            # CODEOWNERS、FUNDING、issue/PR 模板
CCGS Skill Testing Framework/       # 技能/代理质量测试框架(规格、评分细则、目录册)
src/                                # 游戏源代码
assets/                             # 美术、音频、VFX、着色器、数据文件
design/                             # GDD、叙事文档、关卡设计
docs/                               # 技术文档与 ADR
  zh-CN/                            # 中文文档中心:rules 译文 + 翻译术语表
