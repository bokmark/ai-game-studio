...
# 为 AI Game Studios 做贡献

AIGS 是一个在 Claude Code 与 OpenAI Codex 上进行独立游戏开发的协同框架。
...
**本仓库不收纳什么:**
AIGS 是帮你做游戏的系统,不是存放你用它做出来的游戏的地方。
GDD、ADR、PRD、游戏概念、关卡设计、叙事文档,或任何 AIGS 为你自己
...
AIGS 必须能在 Windows(Git Bash)、macOS 和 Linux 上运行。如果你的
