> [中文翻译 / Chinese version](README.md)(默认版本)
...
README.en.md                        # This file — English original
CLAUDE.md                           # Master configuration (Claude Code)
AGENTS.md                           # Master configuration (Codex)
*.zh-CN.md                          # Chinese translation beside each English doc
.claude/
...
.github/                            # CODEOWNERS, FUNDING, issue/PR templates
CCGS Skill Testing Framework/       # Skill/agent QA framework (specs, rubric, catalog)
src/                                # Game source code
assets/                             # Art, audio, VFX, shaders, data files
design/                             # GDDs, narrative docs, level designs
docs/                               # Technical documentation and ADRs
  zh-CN/                            # Chinese docs hub: rules translations + glossary
