...
# Contributing to AI Game Studios

AIGS is a coordination framework for indie game development on Claude Code
and OpenAI Codex.
...
AIGS is the system that helps you build games, not a place to store the games
you build with it. GDDs, ADRs, PRDs, game concepts, level designs, narrative
docs, or any other output generated by AIGS for your own project won't be
...
AIGS is not an autonomous system. Every workflow follows:
...
AIGS must work on Windows (Git Bash), macOS, and Linux. If your hook or
